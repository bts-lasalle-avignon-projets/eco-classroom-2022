...
SELECT indice,libelle FROM IndiceConfort
WHERE idIndiceConfort >= '0';
...
SELECT Salle.nom,IndiceConfort.indice,IndiceConfort.libelle FROM Salle
INNER JOIN IndiceConfort ON IndiceConfort.idIndiceConfort=Salle.idIndiceConfort;
...
SELECT * FROM Mesure
INNER JOIN Salle ON Mesure.idSalle=Salle.idSalle;
